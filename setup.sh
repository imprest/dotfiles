...
# packages
sudo pacman -Syu zsh ranger neovim python-pynvim tree-sitter fzf ripgrep bat ttf-fira-code ttf-jetbrains-mono ttf-fonts-noto-sans-mono exa starship trash-cli lazygit fd\
